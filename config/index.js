export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx20e50beee51f0196",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8a6ed1855dfed8dfacd9ad14562f4180",
   ...
   */
  USERS: [owh6a5iQJ8eI17XWHL8WjfQRKU0Y]
    {
      // 想要发送的人的名字
      name: "嘉嘉你好",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "owh6a5iQJ8eI17XWHL8WjfQRKU0Y",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "q6tWM4PHz4DCIudHI7TzX7Ndzm-O7--PfW-KAhvqgEE",
      // 所在省份
      province: "无锡",
      // 所在城市
      city: "",
  ...
  CALLBACK_USERS: [MrEnJoy-MONEY]
    {
      ...
      id: "owh6a5rxOysq3bXOOSltRWIXqXO0",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
